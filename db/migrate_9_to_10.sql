/* ["-d", "fhc_committee_development", "-e", "MyISAM", "-i", "c:\\ruby_web_apps\\Rails2x\\fhc_committee\\db\\tdefs_9.csv", "-t", "c:\\ruby_web_apps\\Rails2x\\fhc_committee\\db\\tdefs_10.csv"] */
...
ALTER TABLE `task_objs` DROP FOREIGN KEY `fk_task_objs_commitee_committee_id` ;
