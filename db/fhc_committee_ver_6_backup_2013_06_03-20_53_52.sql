...
CREATE TABLE `committee_roles` (
  ...
  `description` mediumtext COLLATE utf8_unicode_ci,
  `calling_required` tinyint(4) DEFAULT NULL,
  `seq_no` int(11) DEFAULT NULL,
...
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (9,'Registration Committee Lead','Ensures that the registration process is smooth both during the on-line pre-registration and day-of registration.',0,5,3,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (10,'Payment Registrar - Priesthood Holder','Ensures that payment information is correctly recorded at www.nefamilyhistory.com. Receives checks and ensures that checks are handled according to church policies.',0,80,3,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (11,'Reg - Hall Monitor','The hall monitors wander the halls of the building and make themselves available to help participants find their classrooms, the bathrooms, etc. Hall monitors are usually missionaries.',0,100,3,0);
...
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (21,'Publicity Committee Lead','Works with Information Committee and others to develop ensure that both church and community leaders have what they need to publicize the conference.',0,9,5,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (22,'PUB - Public Affairs','Ensures that local community is aware of the conference.',0,230,5,0);
...
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (30,'Parking Committee Lead','Arranges for parking on the day of the conference.  Ensures specific parking issues are resolved.',0,310,8,0);
...
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (33,'Networking Refreshments','Plans, purchases and arranges refreshments for networking session at the end of the conference within budget as determined by Conference Committee leadership.',0,340,9,0);
...
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (43,'Speaker Lounge Caterer','Purchases and displays snacks for the speakers in the speaker lounge.  ',0,43,9,0);
...
-- Dump completed on 2013-06-03 20:53:53
