...
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (21,'Publicity Committee Lead','Works with conference web base and Information Committee and others to develop materials that both church and community leaders use to publicize the conference.',1,7,5,1);
...
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `calling_required`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (30,'Parking Committee Lead','Arranges for parking on the day of the conference.  Ensures specific parking issues are resolved.',0,13,8,0);
...
INSERT INTO `committees` (`id`, `code`, `name`, `description`, `seq_no`, `oversight_role_assignment_id`) VALUES (10,'CLEAN','Clean-up Committee','Ensures that the building is clean for Sunday meetings the day after the conference and that furniture has been returned to its rightful place.',11,17);
...
INSERT INTO `committees` (`id`, `code`, `name`, `description`, `seq_no`, `oversight_role_assignment_id`) VALUES (13,'ACCT','Accounting Committee','Collects and records participant payments as they arrive.  Reconciles accounts.  Reimburses for expenses incurred by committee members.  Reimburses syllabus coordinator ~$1200. Reimburses Lunch Fundraiser ~$800.',4,20);
...
INSERT INTO `role_assignments` (`id`, `name`, `event_event_id`, `volunteer_volunteer_id`, `committee_role_committee_role_id`) VALUES (27,'Setup Committee Lead: Frank TRUSCOTT (2014)',10,19,27);
INSERT INTO `role_assignments` (`id`, `name`, `event_event_id`, `volunteer_volunteer_id`, `committee_role_committee_role_id`) VALUES (28,'Technical Committee Lead: Manny Mello (2014)',10,1,25);
INSERT INTO `role_assignments` (`id`, `name`, `event_event_id`, `volunteer_volunteer_id`, `committee_role_committee_role_id`) VALUES (30,'Clean-up Committee Lead: Frank TRUSCOTT (2014)',10,19,34);
...
INSERT INTO `role_assignments` (`id`, `name`, `event_event_id`, `volunteer_volunteer_id`, `committee_role_committee_role_id`) VALUES (33,'Treasurer: Hielner (2014)',10,16,44);
INSERT INTO `role_assignments` (`id`, `name`, `event_event_id`, `volunteer_volunteer_id`, `committee_role_committee_role_id`) VALUES (38,'Parking Committee Lead: Michael Sander (2014)',10,20,30);
...
CREATE TABLE `task_objs` (
  ...
  `commitee_committee_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `fk_task_objs_commitee_committee_id` (`commitee_committee_id`)
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (1,'SETUP - Mount Standard signage','Includes: Bathroom signs (Mens front bathroom is converted to a women\'s bathroom) Handicapped bathroom sign Parking Signs Conference Sandwich Boards at both ends of Jordan Road Non-smoking signs No coffee in the building signs Registration Signage will be mounted by the Registration Committee Classroom Signage will be mounted by the Program Commitee',4,82,12,14,NULL,28,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (2,'HOST - Assemble Speaker Packet','The speaker packet includes the schedule for the day, a program, a copy of the syllabus, etc.',1,103,12,17,219,6,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (3,'PUB - Update Library, Society list','The committee keeps a list of area genealogy societies and libraries and regular libraries and other venues that might be willing to post a poster about the conference. Year to year the list can change. As changes are discovered the list is maintained.  Should include contact information.',1,62,9,11,NULL,21,0,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (4,'REG - Walk-in Registration','On the day of the conference, sit at the walk-ins table and collect information from them so they can be included on our mailing list.  Explain that pre-registered participants take priority for smaller classes and that the class host will also explain this to them.  Make sure they have a walk-in colored name tag so that the class hosts can recognize them as walk-ins.',4,139,12,19,NULL,12,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (5,'LEAD - Conduct Lessons Learned Meeting','Results of participant, speaker, committee member surveys are presented and discussed.  Brainstorming of ideas for addressing issues.  ',2,9,2,1,227,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (8,'CLEAN - Clean Building','Perform all usual cleaning activities associated with preparing the building for Sunday.  Resource: Building cleaning list',4,151,12,NULL,9,35,0,10);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (9,'CLEAN - Fold up Tables and Chairs and Stow under stage','',4,152,12,NULL,NULL,35,0,10);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (11,'CLEAN - Remove Signage and store for reuse','Very important that the signage is returned to the designated box.',4,154,12,NULL,130,35,0,10);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (14,'CLEAN - Create Clean up Committee','Identifies volunteers for cleanup toward the end of the conference and after the conference has closed.',1,83,11,NULL,NULL,34,0,10);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (16,'INFO - Provide Participant Evaluation Results','Develop reports based on survey results to share at lessons learned meeting.',2,10,2,1,82,36,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (17,'LEAD - Obtain Approval for Speaker Expenses','This is a free conference and we generally request that speakers volunteer their time and send us materials for publishing in the paper syllabus and on-line, however, occasionally a speaker submits a request for reimbursement.  These may appear before or',1,86,11,NULL,174,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (18,'LEAD - Oversee Conference Day','Ensure that the day goes smoothly.  Resolve issues.  etc.',4,114,12,NULL,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (20,'LEAD - Prepare Public View of Website','Update the main page of the website to reflect the information for the current year\'s conference.',4,34,7,NULL,32,3,1,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (21,'LEAD - Respond to Pre-Conference Questions','Prior to the open of pre-registration, email is responded to by one of the co-chairs.  Messages can be forwarded to the co-chair\'s email if desired.  It is recommended that these messages are responded to from the conference gmail account to avoid the mix of conference and personal email.',2,8,2,NULL,5,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (23,'LEAD - Suggest Sub-committee Leaders','',1,28,6,6,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (24,'LEAD - Set Budget for Networking Refreshments','',2,92,11,NULL,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (25,'LEAD - Set Budget for Speaker Gift','',2,93,11,NULL,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (26,'LEAD - Request new Website Function','Send proposal for new function to web master for discussion and prioritization.',4,27,3,NULL,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (27,'PROG - Create Roadshow Slot','A Roadshow slot is a 15 minute time when a speaker is available for a one-on-one consultation with an individual participant to help them with a specific issue they are having with their research.  In order to schedule the Roadshow slots we need to know when the speakers are scheduled to present their formal presentations.  We do not need to have finalized the rooms where they will present.',4,46,7,8,28,39,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (28,'PROG - Create Speaker Record','Enter the speaker information (contact info, bio and picture) into www.nefamilyhistory.com',1,19,6,8,134,39,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (29,'PROG - Declare website ready for pre-registration','Checklist for website readiness:\r\n\r\n1. Main page is complete and has been proofread.\r\n2. Speaker contact information is complete and proofread\r\n3. Speaker bios complete and proofread\r\n4. Speaker photos loaded.\r\n5. Presentation titles confirmed with speakers.\r\n6. Presentation descriptions complete and proofread.\r\n7. Roadshow slots created for those who want to do them.\r\n8. Participant Login function has been tested and confirmed. \n\nThe following can be completed later:\r\n\r\n1. Speaker Needs \r\n2. Assignment of presentations to rooms',1,59,9,7,27,39,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (30,'LEAD - Frame the Program','Determines what will be taught at the conference.  Uses feedback from previous evaluations along with information about past conferences to design a program that will satisfy the broad range of needs of our participants.',1,15,7,5,170,3,1,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (32,'LEAD - Initialize Website for new Conference','The participant side of the website holds information for a single conference.  Once that conference is over the information for the current year is copied to the historical part of the website for future reference.  A new conference is initiated (new Event record) and the new conference information (speakers, presentations, etc.) is then added.  The program manager works with the information committee lead to decide which items should be deleted and which can be reused for the next conference.',4,17,2,NULL,201,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (35,'REG - Participant Registers for a Roadshow Appointment','The participant sees that participant view of the roadshow appointments.  Once a participant has signed up for a roadshow appointment, the name of the participant will appear from the administrator view of the same information.',2,78,10,19,216,37,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (36,'LEAD - Report Expenses for Reimbursement','',4,200,1,NULL,18,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (37,'PROG - Schedule Presentation','Determine when the presentation will be presented, which track and which time.',2,64,9,7,136,39,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (38,'PUB - Coordinate Newspaper Articles','Arranges for local papers to write stories about the conference in local papers.',1,57,9,11,NULL,22,0,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (39,'PUB - Coordinate Press Releases','Arranges for the design of press releases, contacts newspapers and others that are willing to publish press releases',1,58,9,11,NULL,22,0,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (41,'PUB - Maintain List of Local Newspapers','Creates/updates list of newspapers in and around Franklin, including all towns within the Franklin Ward and Branch and neighboring towns such as Cumberland, RI, Woonsocket, RI, Pawtucket, RI and Providence, RI.  Should include contact information.',1,41,7,11,NULL,21,0,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (42,'PUB - Obtain Publicity Contact Lists','Obtain/create list of Family History Consultants, Other Stake Presidencies.',1,42,7,11,NULL,21,0,5);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (44,'PUB - Distribute Publicity Packets','Packets may be distributed to FH Consultants, Hingham Stake Bishops, Other Stake Presidencies/Bishops.',1,73,10,11,194,23,0,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (45,'PUB - Assemble & Distribute FH Consultant Packets','',1,47,8,11,194,24,1,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (46,'PUB - Obtain FH Consultant List','',1,32,6,11,NULL,24,0,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (47,'INFO - Create Poster','Uses committee ancestor photos to design posters.  If expense is approved, poster may be in color.',1,48,8,NULL,208,14,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (48,'INFO - Create News Paper Add','Uses committee ancestor photos to design newspaper ads.  See Communications Committee, public relations member for specific sizes.',1,49,8,NULL,NULL,14,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (49,'INFO - Create Program and Syllabus Cover','Uses committee ancestor photos to design program cover (letter folded in half  5.5 x 8.5 vertical) and syllabus cover, 8  x LEADLEAD',1,50,8,NULL,208,14,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (50,'INFO - Obtain Committee Ancestor Photos','Coordinates with Information Committee Member responsible for collecting committee ancestor photos.',1,52,8,NULL,NULL,14,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (51,'INFO - Create CD of Photos','Create CD of photos and give it to the information committee lead for load onto wesite',4,157,12,NULL,NULL,20,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (52,'INFO - Document the Day','Photos of people arriving, at registration, parking attendants, lunch preparation, etc.',4,159,12,NULL,NULL,20,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (53,'INFO - Photograph attendance','Photos of the class participants, photo of the chapel when full at the beginning.',4,146,12,NULL,NULL,20,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (54,'INFO - Photograph each speaker at work','Photos of speakers giving their presentations.  Makes every effort to take flattering pictures.',4,147,12,NULL,NULL,20,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (55,'INFO - Photograph Setup','Photographs of each room and how it is setup for future setup committee.  Dont forget the speaker lounge.',4,129,12,NULL,NULL,20,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (56,'INFO - Take informal Photos','Candid shots when participants and speakers are relaxed.  At lunch, at networking session.',4,148,12,NULL,NULL,20,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (57,'INFO - Announce Syllabus Download available - Participants','An email goes out to the current list of participants (not the entire mailing list), when the majority of the syllabus inserts are ready for download.  Subsequent messages are sent out when remaining inserts have been posted.',2,89,11,NULL,59,15,1,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (58,'INFO - Assemble Paper Syllabus','Syllabus inserts are provided by individual speakers via email in Microsoft Word format. Syllabus Coordinator assembles the Syllabus into a book. The syllabus book includes: * a cover with graphics that match the posters, program and other graphical materials * a copy of the program grid * a table of contents with page numbers * dividers for each speaker with their biography and picture * the syllabus materials provided by the This is a technical activity, there are many issues with how the materials are provided that need to be ironed out. The person selected for this role needs to have intermediate to advanced MS Word skills.',1,71,10,NULL,84,16,1,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (59,'INFO - Load PDFs into Website for Free Download','It is recommended that the speakers are requested to provide their inserts in two forms, MS Word and PDF, however it is unlikely that all speakers will have this capability. Converts MS Word syllabus inserts from MS Word into PDF files. (We use PDF files to avoid incompatiblity/version issues with use of MS Word.) Loads the PDFs onto the website and tests each download.',1,74,10,NULL,84,16,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (61,'INFO - Turn on Pre-registration for the Conference','When the program is ready for participants to login, the programmer will make the participant website available for participant pre-registration.',1,65,10,NULL,NULL,19,1,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (62,'INFO - Turns on Website Under Construction','As the program is developed the website will be changing as new content is added and revised to create the new program. The programmer will turn off participant logins during this period. Administrator logins (committee members) will remain active.',1,16,4,NULL,180,19,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (63,'INFO - Develop Management Reports from the Database','Provides specialized reports to leadership based on needs.',1,43,6,NULL,NULL,13,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (64,'INFO - Interface with Website Programmer','Understands issues with website and documents new requirements and works with programmer to schedule, implement and test new functions.',1,28,3,NULL,NULL,17,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (66,'INFO - Maintain Conference History','Maintains lists of topics, committee Roles & Tasks, frequently asked questions, etc.  Maintains conference program and mailing list.',1,73,1,NULL,NULL,13,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (67,'INFO - Maintain Non-Program Related Web Content','',1,200,1,NULL,NULL,13,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (74,'INFO - Announce Pre-Registration Open - Mailing List','Send email to entire mailing list indicating that they can pre-register for the conference.  See example wording below.',1,66,10,NULL,29,15,1,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (75,'INFO - Announce SAVE THE DATE - Mailing List','Send email to entire mailing list via Mail Chimp.  See example wording below.',1,44,7,NULL,NULL,15,1,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (76,'INFO - Support FH Consultant Coordinator Information Needs','',1,61,9,NULL,NULL,18,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (232,'HOST - Provide Speaker Evaluation Results','Compile feedback from speakers and present at the Lessons Learned meeting.',2,10,1,17,230,5,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (78,'INFO - Support Registration Committee  Pre-registration','Ensures that registration committee has everything they need from the FHC database during pre-registration and as they prepare the packets for the participants.',1,132,10,NULL,NULL,18,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (80,'INFO - Train New Committee Leaders on use of website','Prepares and presents training on how to use the web application.  This may include classroom training, webinars and provision of written training materials.',1,25,3,NULL,165,17,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (81,'INFO - Collect Committee Ancestor Photos','Collects photos, may involve photographing old photos.  Going to peoples houses.  Once photos are in digital format, sends photos to Graphics designer for use in posters etc.',2,45,7,NULL,NULL,14,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (82,'INFO - Create/Update On-line PARTICIPANT Evaluation','Updates survey on Survey Monkey to meet needs of current year.  Updates Mail Chimp participant mailing list based on final list of participants, including walk-ins.  Send announcement to participants indicating that the link is available on the www.nefamilyhistory.com website.  Need to make sure the link has been updated before the announcement is sent.',3,3,12,NULL,18,36,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (83,'INFO - Load Committee FH Photographs','The committee has a tradition to use photographs of our own ancestors to decorate the family history website and graphics.',1,51,8,NULL,NULL,17,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (84,'PROG - Obtain Syllabus Inserts','See also, Speaker Engagement Script.  Establish deadline and communicate it to the speakers.  Make initial request from each speaker, send reminders and follow-up as necessary.',1,85,11,NULL,137,40,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (86,'INFO - Support Comm Committee with Information Needs','Provides any information that can be gleaned from the FHC database that helps with communication.',1,54,8,NULL,NULL,18,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (88,'INFO - Support Host Committee Speaker Packet Assembly','Print speaker name tags (different color from participant name tags), print additional information as directed by the Speaker Host Committee Lead',4,102,12,NULL,215,18,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (89,'FOOD - Assemble and Distribute Lunches','Leads assembly and distribution of lunches on the day of the conference.',4,117,12,NULL,NULL,32,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (90,'FOOD - Design Lunch Menu','Selects sandwich choices, fruit, other dessert, drinks, etc.  Updates menu in Event object from admin view of the web application www.nefamilyhistory.com',4,56,8,18,NULL,32,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (91,'FOOD - Purchase Lunch Food','The lunch budget is the lunch price times the number of participants who have paid for their lunch.  Pre-registration closes 2 weeks before the conference.  It is best to wait until LEAD week before the conference to be sure as some numbers can change in the transition week.  In addition you will be providing lunches for the speakers (free) and the missionaries (free).  The website keeps track of the number of participants who have paid for their lunch.  Reminder emails are sent to participants who have ordered lunch but who have not paid for it up to the last week.  Check with the committee leadership on number of extra lunches to be sold on the day of the conference.  It is usually LEAD0% extra.  Contact people who have held the role in the past for advice.',4,107,12,NULL,213,32,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (92,'FOOD - Display & Maintain Networking Food','Creates display of networking food and maintains the display as the food is consumed.',4,144,12,NULL,95,33,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (94,'FOOD - Purchase Food for Networking Session','Check with committee leadership for budget for networking session.  Check with those who have previously had the role for quantities.',4,119,12,NULL,222,33,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (95,'FOOD - Select menu for networking session','Must include healthy and non-sweet options for those who have health issues with sugar.  Fruit and vegetable plates in addition to cookies and other sweets.  Resources: Photos of food from previous networking sessions.',1,118,12,18,NULL,33,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (97,'PARK - Create Parking Sub-committee','Identifies volunteers to help with parking for the day of the conference (can use some missionaries)',3,97,11,3,166,30,0,8);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (98,'PARK - Direct Committee Members in Parking','Assigns specific tasks to Parking committee Members',4,115,12,10,184,30,0,8);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (99,'PARK - Direct Vehicle Drivers in Parking','Ensure that vehicles are parked in a manner than ensures safety, efficient use of space and the ability for vehicles to leave in an orderly manner.',4,116,12,10,NULL,31,0,8);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (100,'ACCT - Identify Unpaid Participants','When all checks have been received, the Payment Registrar will provide the Registration Lead with a list of participants who have not paid.',1,70,10,NULL,102,44,0,13);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (101,'ACCT - Receive checks and processes bank deposits','Receive check and record in system. Create periodic deposit (group of checks) and print deposit slip for bank. Recheck that each check is correctly recorded on the deposit slip. Make any adjustments in the system and recreate the deposit if necessary.',1,68,10,NULL,197,44,0,13);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (102,'ACCT - Record which participants each check covers','A critical element of this role is to indicate which participants are being paid for by a given check. Often a participant will pay for a friend or family member. This step is essential in ensuring a smooth registration process. If it is unclear whether someone has paid it causes a great deal of heartache for both the participant and the registration comittee.',1,69,10,NULL,NULL,44,1,13);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (103,'ACCT - Send payment reminder to participant','Often a participant will sign up for the conference, but then will forget to pay.  We provide the ability for the Payment Registrar to create a list of emails to send a reminder email to.  The team member can either use their own email account or use the conference account nefamilyhistory@gmail.com',2,95,11,NULL,100,44,0,13);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (106,'REG - Customer Service','Ensures smooth registration process.  Begins as soon as pre-registration is announced.',1,67,10,19,74,11,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (107,'REG - Develop Registration Committee','Identifies and requests the service from potential committee members to help with packet assembly and registration on the day of the conference.  Need 4-6 people for packet assembly and at least 8 people for the day of the conference.',1,30,3,NULL,NULL,9,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (108,'REG - Ensure Participant Info is Complete and Correct','The registration committee lead is the person closest to the participants and the correctness of the information about the participants is key to ease of assembly of the participant packets as well as happy participants on the day of the conference.  It is a good idea to check each day during pre-registration to ensure there are no duplicates, no oddballs, i.e., Mickey Mouse.  Also check that participants have completely the information.',1,84,11,NULL,74,9,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (109,'REG - Monitor Conference Email Account','Triages email communication from conference participants during the pre-registration process before the conference. Responds to emails from conference participants during the pre-registration process. Forwards emails to other committee members for special expertise.',1,60,9,19,NULL,9,0,3);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (111,'REG - Participant Problem Resolution','Answers participant questions and solves participant problems regarding their individual situation (registration packet, syllabus, payment, schedule, etc.) during the leadup to the conference through email and over the phone. Connects participants up with others who can solve their issue when needed, for example, the web master, the setup people regarding a special needs issue, etc.',1,75,10,19,213,9,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (112,'REG - Registration Setup','During the setup of the conference, ensures that the registration areas are setup according to the committees needs.  Mounts registration specific signs, i.e., signs that direct participants to one side of the building or the other. Signs that direct participants to a specific part of the registration table. Signs for Walkins. Any other signs specific to the smooth running of Registration.',4,133,12,19,NULL,9,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (113,'REG - Assemble Participant Packet','Accurately and efficiently stuff 400+ participant packets with conference materials.',3,112,12,19,195,12,1,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (114,'REG - Participant Registration','On the day of the conference, sit at one of the registration tables and pass out registration packets to participants who have pre-registered.  Report issues to Registration Lead.  Some registration committee members will register walk-ins.  The walk-in will fill out a paper form (see below) and the registration committee member will update the mailing list.',4,138,12,19,NULL,12,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (198,'HOST - Assign Lodging/Transportation Provider to Speaker','Introduce the Speaker, usually via email, to the person(s) who will be providing them with transportation or lodging.',2,94,11,17,207,40,0,2);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (117,'SETUP - Set up unused spaces with tables for dining','Tables and chairs are setup in unused classroom spaces to provide additional dining space.  The stage, smaller classrooms on both sides of the cultural hall.',4,123,12,15,NULL,28,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (118,'SETUP - Setup Furniture in Classrooms','Setup classrooms and cultural hall according to previously established pattern. Understand specific speaker needs for classroom and ensure stand for projector, display equipment, easels, table, podium, etc are available.',4,124,12,15,NULL,28,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (119,'SETUP - Setup Networking Refreshments Table','The Networking table is stored behind the folding wall in the overflow area during the last presentation. The food is setup during the last presentation. The table is then scooted out, with the food already on it, into the Cultural Hall all ready for the Networking Session.',4,125,12,13,NULL,28,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (120,'SETUP - Setup Furniture in Registration Areas','Registration is setup for half the participants in the lobby (Stake Offices side), and the other half in the lobby (Bishops Offices side). The walk-ins table is setup on the Bishops Offices side. Setup of the Registration Area is to be coordinated with the Registration Committee Leader.',4,126,12,15,NULL,28,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (121,'SETUP - Setup Furniture in Speaker Lounge','Furniture (couches, chairs and small tables) from lobbies is arranged into a lounge for the speakers. See Speaker Lounge photographs in Setup Book',4,127,12,15,NULL,28,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (122,'SETUP - Arrange for Table Decorations','Decorate all tables designated as dining tables.  Maybe all over the building.  There are fake flower decorations somewhere.',3,109,12,14,NULL,29,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (123,'SETUP - Arrange for Tablecloths','Ensure that all tables designated as dining tables have tablecloths.  We have used cloth tablecloths some years, but paper is fine as well and easier to cleanup.',3,110,12,14,NULL,29,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (124,'SETUP - Decorate Speaker Lounge','Decorate speaker lounge.  Check with the committee leadership as to whether there is a budget for Decorating.  Nice to have fresh flowers in the speakers lounge.',4,120,12,14,NULL,29,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (125,'HOST - Arrange Speaker Flights','Arrange airplane transportation for those coming from long distances (Florida, Utah).  Work with Executive Sponsor for access to donated frequent flyer points or other methods of payment.',1,82,11,17,141,1,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (126,'PROG - Assign Classroom to Presentation','Once pre-registration is closed, we have the information we need to determine which classroom will be used for each presentation.  Based on the number of participants signed up for each class the best classroom is selected.  This is done in the web application.\r\n\r\nFactors in this decision:\r\n\r\n*Capacity:* Where possible allow for walkins.\r\n*Speaker Convenience:* Try to make it so that speakers do not have to move from one room to another.',3,113,12,NULL,NULL,40,1,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (127,'PROG - Develop Classroom Sign Plan','Creates/updates classroom sign plan. Signs and information to be included: * Classroom Letter Designator (laminated Letter) * Classroom schedule (classes for each session) - printout from www.nefamilyhistory.com * Other materials',1,105,12,NULL,NULL,39,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (128,'HOST - Develop Speaker Host Committee','Ensures Speaker Hosts understand their role and tasks.  Ensures that Speaker Hosts have all resources they need to carry out their tasks, oversees progress and resolves issues.',4,31,10,17,NULL,5,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (130,'PROG - Mount Classroom Signs','Mounts signs that indicate information about each class at the class room door.  This includes the signage associated with the Roadshow.  \r\n\r\nThe setup book includes photos of exactly how to mount these signs.',4,130,12,14,236,42,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (131,'HOST - Purchase Speaker Gifts','Designs, purchases and assembles thank-you gift for each speaker that is within the budget provided by the committee leadership.  Contact prior gift designers for ideas.  The gifts should be delivered to the Speaker Lounge (Young Womens room) the day before or the morning of the conference.',2,91,11,17,NULL,8,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (132,'HOST - Arrange Speaker Lodging','Working with the Speaker Host Committee Lead, identifies church members and others willing to host a speaker in their home for one to two nights.',1,81,11,17,141,6,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (133,'HOST - Care for Speaker','On the day of the conference, attends to any special needs the speaker may have. Helps find tech helpers needed by the speaker. Ensure they have water. Whatever is needed.',4,136,12,17,NULL,6,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (134,'PROG - Collect and Document Speaker Information','Enter the speaker information (contact info, bio and picture) into www.nefamilyhistory.com.',1,35,7,8,NULL,40,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (135,'HOST - Count Participants in Class','On the day of the conference, it is important that we count the number of participants in each class.  As the speaker host you will have a piece of paper on which to write the count and you will be directed where to leave it.',4,142,12,17,NULL,6,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (136,'PROG - Create Presentation Record','Enters description of each class and associated information about a presentation in to www.nefamilyhistory.com',1,20,6,NULL,NULL,40,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (137,'PROG - Engage Speaker to Present','This is the most important task of the whole conference preparation phase!  We need to keep our speakers happy so they will do a great job presenting and so that they will be willing to come back again.  Identify speaker based on Program Frame.  Engages with speakers to request they speak at the conference.  See Speaker Script for additional information and specifics of what you will be asking of the speaker.',1,18,6,8,134,40,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (139,'HOST - Follow up with Speaker','Ahead of the conference, proactively contacts assigned speakers to ensure they are prepared and ready to speak and to ensure they have sent you everything that is needed for the website and the syllabus.  Please be prompt in responding to speaker communication.  You will sent the syllabus insert to the Information Committee Member responsible for assembling and the paper syllabus and uploading the digital syllabus.',1,37,7,17,NULL,6,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (140,'HOST - Greet Speaker','On the day of the conference, the Speaker Host should be available to greet the speaker(s) they have been assigned and show them to the speaker lounge and check with them at that point as to whether there is anything they need. Point out the bathrooms, handicapped is closest to the speaker lounge.  The speaker host might also introduce the speaker to other speakers especially if they are new.  This is the real host part!  J',4,135,12,17,241,6,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (141,'HOST - Identify Speaker Hospitality Transportation Needs','If a speaker comes from a long distance, determine if they need: * transportation (airplane ticket, pickup at airport, train station, etc.). * lodging (number of nights)',1,67,7,17,NULL,6,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (142,'HOST - Introduce Speaker to Class','On the day of the conference, in the past, the host has just read the speaker bio.  Often the speaker bio is dull sounding, too long or otherwise not that interesting to listen to.  Ideally, the speaker host will contact the speaker and ask them to write what they would like the host to read as an intro.  The intro may be different for different classes, for example, what was it that made the speaker particularly interested in the topic.  We have had feedback that the intros are repetitive (people attending two classes or more from the same speaker).',4,141,12,17,NULL,6,1,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (143,'HOST - Manage Participant Classroom Entry','On the day of the conference, participants who pre-registered for a class get priority over those who walked in on the day of the conference. The host ensures that the pre-registered people (name tag color distinguishes pre-registered participants from walk-ins).',4,140,12,17,NULL,6,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (144,'PROG - Register Speaker','This function enables speakers to update the information about themselves and their presentations and also to monitor their class sizes.',1,33,6,8,134,40,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (146,'LEAD - Provide High-Council Interface','',1,128,4,NULL,147,2,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (147,'LEAD - Determine date of the conference','The conference is usually held on the last Saturday of March, however, care needs to be taken that no competing activity is planned for the same day that might detract significantly from the conference.',1,2,1,NULL,NULL,1,1,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (148,'TECH - Direct Setup of Technology','* Conveys needs to sub-committee members * Assigns specific setup tasks to sub-committee members * Ensures that technolgoy has been tested',1,106,12,14,NULL,26,0,6);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (149,'TECH - Provide ad-hoc assistance to Speakers','Supports the Tech Lead on the day of the conference for resolution of techical issues, especially for the speakers',4,137,12,NULL,NULL,26,0,6);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (151,'TECH - Setup Technology','Setup projectors, laptops, and run wires, solicit for extension cords',4,128,12,14,NULL,26,0,6);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (152,'TECH - Create Tech Sub-committee','* Identifies volunteers to participate as tech sub-committee members * Conveys sub-committee objectives and role',1,72,10,NULL,NULL,25,0,6);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (153,'TECH - Determine Technology Needed for conference','Works with Committee Leadership and other Committee members to determine technology needs.',2,90,11,NULL,191,25,0,6);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (154,'REG - Participant downloads syllabus','Participants all have the option to download and print the syllabus from the website themselves.',2,96,11,NULL,57,37,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (155,'INFO - Create Information Committee','Identifies volunteers with skills needed to support the information needs of the committee.',1,36,3,NULL,NULL,13,0,4);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (159,'INFO - Update Conference Mailing List','Ensures that all emails added to the web base during a new conference are transferred to the Mail Chimp Conference Mailing List.',1,6,1,NULL,114,15,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (160,'REG - Review Roadshow Participation','Check on whether a participant roadshow appointment is correct.',3,79,10,19,NULL,12,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (161,'LEAD - Solicit Community Volunteers','Ask for assistance from the contacts list for all kinds of help on the committee.  Assign volunteers to committees based on their interests and skills.',4,23,3,NULL,170,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (162,'LEAD - Transition to New Leadership Team','Participate in lessons learned meeting and provide advice as the new leadership team initiates the planning process.',2,21,2,1,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (163,'INFO - Update Participant Evaluation Link on Website','Person doing the survey will provide the new link.  This needs to be changed on the website so the participants can reach the current year\'s survey.',1,5,1,NULL,82,17,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (166,'LEAD - Sub-committee Lead Transition','Each sub-committee lead from the previous year, explains the role to the sub-committee lead for the following year.  This handoff should include training on how to use the web application to perform these duties.  Information on expenses for the role, which supplies or materials might be needed and where they are located.',2,26,3,3,246,NULL,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (167,'PUB - Send flyer to area Libraries and Gen. Societies','Email flyer to the libraries and genealogical socieities throughout New England.  See example wording below.',1,77,10,11,194,23,0,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (168,'LEAD - Invite Stake Members to Attend','Message to all Hingham Stake members to attend the conference.',1,88,11,NULL,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (169,'HOST - Follow-up with Speaker Hosts','Email to speaker hosts to explain to them specifically what they need to do to support their speaker(s) on the day of the conference.  The attached announcement is provided as an example.  Your message may be different depending on decisions made for your conference.',2,108,12,17,128,5,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (170,'LEAD - High Level Planning','Set up the new organization.  Make adjustments to committee role definitions, etc.  Make calling requests, for sub-committee leads to the Stake leadership.  Discuss how community volunteers will fit in.  Review budgetary constraints.',2,11,2,6,171,3,1,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (171,'LEAD - Set Objectives for Next Conference','Based on feedback from all constituents (participants, prior year\'s committee members and speakers), input from Stake Presidency and thoughts from new committee, develop measurable objectives for new conference.',2,12,2,6,NULL,1,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (194,'INFO  - Create Flyer','The flyer is usually an 8.5 x 11 version of the poster with the program schedule printed on the back.',2,194,8,NULL,37,14,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (193,'FOOD - Purchase Water for Breaks','Ensure that there is water placed on break tables in the hall ways.\r\n\r\nIn 2013 we had 6 cases of 48 count small bottles plus 1 case of 32 larger bottles for networking.  We did not have any leftover. ',4,247,12,NULL,NULL,38,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (195,'INFO - Have Syllabus Printed','Take completed file on a thumb drive to the printer and request that they print the syllabus according to the following instructions:\r\n\r\nPrint main portion of the book, in black and white, on regular paper (20 lb) - If anything needs to be in color, we need to discuss that with the speaker and with the Co-chairs - color can make the syllabus VERY expensive, not just because of the color printing, but because of hand collating that has to be done to insert the color pages.  Sometimes we have created separate handouts, but even this can be costly depending on the size of the class.\r\n \r\nPrint the cover on buff colored or ivory card stock - We may need to make a call on whether the cover is printed in color, need to get a quote to decide.\r\n \r\nProvide a blank back of the same card stock\r\n\r\nGBC bind the book\r\n\r\nThe book should cost no more than what we have advertised it for.',3,101,12,NULL,213,16,1,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (196,'PROG - Research/identify New Speakers','Through research and contacts find new speakers for the conference.  Solicit ideas from participants.',1,1,1,8,134,3,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (197,'ACCT - Setup Post Office Box','The payment reigstrar sets up a Post Office Box in a location that is convenient to him.  The PO Box will be used as the address where participants will send their checks for lunch and syllabus.',4,80,10,NULL,74,44,0,13);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (199,'LEAD - Select Sub-committee Leaders','Identify potential leaders for the various sub-committees.',1,13,6,NULL,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (200,'PROG - Develop Program Committee','Identifies volunteers to help on the program committee.  Understands program development requirements and trains committee members on specific tasks.  Holds sub-committee meetings as needed.  Ensures committee members have resources they need to do their tasks.',4,14,3,NULL,NULL,NULL,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (202,'LEAD - Orient Sub-committee Leaders','Ensure that all sub-committee leaders understand the overall process for creating the conference.',4,22,3,2,234,3,1,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (204,'LEAD - Orient Community Volunteers','Individual committee leads orient/train the volunteers assigned to their committee.',4,24,3,NULL,234,NULL,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (205,'PUB - Develop Publicity Committee','Identifies volunteers to help on the publicity committee.  Understands publicity requirements and trains committee members on specific tasks.  Holds sub-committee meetings as needed.  Ensures committee members have resources they need to do their tasks.',1,29,3,11,NULL,21,0,5);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (207,'HOST - Identify Lodging Providers/Transportation Providers','Create list of church members willing to host a speaker in their home for one or two nights.  Create list of church members willing to drive a speaker from or to the airport.',1,40,7,17,137,5,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (209,'LEAD - Oversee overall quality of website content',NULL,1,53,8,NULL,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (213,'INFO - Turns off Pre-Registration','Send email to all participants to remind them that pre-registration is clopsed, but they can still attend the conference as a walk-in.  ',3,99,12,NULL,NULL,17,1,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (218,'INFO - Support Registration Committee Registration Packet','Prints participant name tags, prints committee name tags, prints participant schedule pages, prints copies of FH Consultant Contact list, and other information needs as directed by the Registration Committee Lead.',4,100,12,9,108,18,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (221,'REG - Arrange Participant Packet Assembly Party','Works with a team to put all participant materials: * Participant Schedule * Lunch Ticket * Name Tag * Program * etc. together into an envelope with the participants name on the front.',3,111,12,NULL,NULL,9,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (224,'LEAD - Determine opening session specifics','Identify who will speak at the opening session.',4,131,12,NULL,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (225,'PROG - Generate Program and Print','Create the program from the website.  (New function to be added for 2014)',4,132,12,NULL,224,39,1,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (227,'LEAD - Establish Final Count of Participants','Count number of participants in chapel.  Get classroom counts from Speaker Hosts.',4,143,12,NULL,135,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (230,'HOST - Create/Update On-line SPEAKER Evaluation','Updates survey on Survey Monkey to meet needs of current year.  Send announcement to speakers with the link to the evaluation at Survey Monkey.  Need to make sure the link has been updated before the announcement is sent.',1,3,1,17,232,5,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (231,'LEAD - Create/Update On-line COMMITTEE Evaluation','Updates survey on Survey Monkey to meet needs of current year.  Send announcement to all committee members with the link to the evaluation at Survey Monkey.  Need to make sure the link has been updated before the announcement is sent.',1,3,1,NULL,18,13,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (233,'INFO - Provide Committee Evaluation Results','Compile results of committee evaluation and present at lessons learned meeting.',2,10,2,1,231,13,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (234,'INFO - Update Committee Handbook','Adjust committee descriptions, roles and tasks based on outcomes of Lessons Learned and Planning meetings.',4,4,2,6,5,13,0,4);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (235,'LEAD - Oversee Sub-committees','Participate in committee status meetings to offer help and ensure that all the process is moving along smoothly.',1,235,3,16,NULL,3,0,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (236,'PROG - Print Classroom Signage & Program','These two tasks need to be done together to ensure that they match.',1,236,11,13,126,42,0,11);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (237,'REG - Registration Soft Setup','On the Friday before the conference, set out the boxes of participant packets, make sure that each station has pens, and any other supplies needed.',4,237,12,19,120,9,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (238,'REG - Registration Soft Setup','On the Friday before the conference, set out the boxes of participant packets, make sure that each station has pens, and any other supplies needed.',4,238,12,NULL,120,9,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (239,'HOST - Arrange Speaker Gifts in Speaker Lounge','This is done as part of Soft Setup so that they are ready first thing in the morning when the speakers arrive.',4,239,12,17,131,8,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (240,'SETUP - Request Setup Period for Conference','Ensure that the calendar is completely clear for the setup period, the Thursday and Friday, before the conference.  Request that all those who might want to use the building have been notified that the building is unavailable from Thursday at 5pm through Saturday at 5pm. This includes recitals, basket ball, and all other activities.',4,240,12,13,NULL,27,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (241,'HOST - Arrange Speaker Packets','',4,241,12,17,2,5,0,2);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (242,'PARK - Setup Parking Dividers for Speakers, etc.','Place cones and ropes to indicate exactly where speakers should park.',4,242,12,10,NULL,30,0,8);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (243,'SETUP - Setup Roadshow Room(s)','These are small classrooms where a genealogist can meet one-on-one with a participant.  May also be held in the family history center.',4,243,12,15,116,27,0,7);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (245,'SETUP - Setup Planning','',2,245,11,13,116,27,0,7);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (246,'REG - Inventory Registration Supplies & Materials','It is very helpful to have an updated inventory of what is left over from the previous year.  All supplies and materials should be left in the box on the shelf in the Franklin Family History Center.',1,246,1,19,18,9,0,3);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (247,'FOOD - Cater Speaker Lounge','Provide light breakfast snacks for the speakers for example, fruit and banana bread. ',4,145,12,18,NULL,43,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (248,'ACCT - Reconcile Finances','Finalize all financial matters having to do with the conference.',4,248,12,21,249,45,1,13);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (249,'ACCT - Collect Payments on Conference Day','Collect payments on conference day.',4,249,12,16,114,45,0,13);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (250,'FOOD - Create Food Sub-committee','Identifies volunteers to fill the food committee roles, see FOOD Committee main page.',3,250,7,NULL,202,38,0,9);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`, `commitee_committee_id`) VALUES (251,'FOOD - Scope Other Fund Raiser','Agree on what will be provided as a secondary fund raiser.',2,251,7,18,250,46,0,9);
...
INSERT INTO `volunteers` (`id`, `l_name`, `f_name`, `full_name`, `email`, `email_confirmed`, `user_name`, `passwd`, `address_line1`, `address_line2`, `city`, `state`, `zipcode`, `cell_phone`, `home_phone`, `work_phone`, `missionary_ind`, `created_at`) VALUES (20,'Sander','Michael','Michael Sander','',0,'','','','','','','','','','',0,'2013-06-08');
...
-- Dump completed on 2013-06-09 23:28:54
