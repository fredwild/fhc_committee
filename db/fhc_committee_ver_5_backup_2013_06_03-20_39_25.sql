...
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (1,'Executive Sponsor','Provides executive leadership and guidance on overall shape and objectives of the conference.',1,1,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (2,'Stake High Council Advisor','Provides communication line with High Council.  Helps get the word out through the stake, helps identify resources through stake council resources, etc.',2,1,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (3,'Co-chair','Provides leadership and management capabiitilies to ensure all aspects of the conference run smootly. Provides decision making regarding expenses, resolves cross-committee issues and ensures all conference committee members feel well supported.  Ensures that sub-committee leaders have resources to do their tasks. Monitors progress of selected sub-committees (each of two co-chairs is assigned set of sub-committees).  Schedules meetings, develops agenda for meetings with input from committee members, participates in selected sub-commitee leads.',3,1,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (5,'Host Committee Lead','Oversees the Speaker Host committee, supports the committee members to ensure they have resources they need. There are specialized resources in this case, including member homes to host speakers, member support in providing transportation, etc. Resolves issues for speaker hosts.  Ensures the quality of the content of the website regarding speakers and presentations.  www.nefamilyhistory.com',7,2,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (6,'Speaker Host','Takes over for Program Committee member to follow up with speaker and interfaces with other committee members and leadership to resolve any issues.  Helps speaker on the day of the conference.  Ensures they have water, tissues, anything else. Introduces the speaker (reads bio or speaker provided introduction). Maybe a FH Consultant.',60,2,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (7,'Unassigned','This role is used when no role has been assigned to a person registering as a committee member.',62,1,NULL);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (8,'Speaker Gift Designer','Designs thank-you gift for each speaker. Purchases gift(s), wraps and delivers gift to speaker lounge on the day of the conference. Gift is subject to budget set by Conference Committee leadership.',70,2,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (9,'Registration Committee Lead','Ensures that the registration process is smooth both during the on-line pre-registration and day-of registration.',5,3,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (10,'Payment Registrar - Priesthood Holder','Ensures that payment information is correctly recorded at www.nefamilyhistory.com. Receives checks and ensures that checks are handled according to church policies.',80,3,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (11,'Reg - Hall Monitor','The hall monitors wander the halls of the building and make themselves available to help participants find their classrooms, the bathrooms, etc. Hall monitors are usually missionaries.',100,3,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (12,'Registration Committee Member','Supports the Registration committee lead in assigned tasks.  May help assemble participant packets, may assist participants during registration, may support the registration lead with answering pre-registration questions.',90,3,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (13,'Information Committee Lead','Ensures that all information needs are met and that information flows smoothly and meets the needs of all committee members. Notes where there are issues for future improvement.',8,4,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (14,'Info - Graphics Designer','Designs posters, flyers, program cover, syllabus cover, and other graphic needs for the conference.  Ensures a consistent look for the conference - with consideration that program cover, syllabus cover and flyers will be printed in black and white.',130,4,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (15,'Info - Mailing List Coordinator','Ensures that contacts list in nefamilyhistory.com matches the mailing list in Mail Chimp.  Ensures that the Participants mailing list for a given year is maintained during the pre-registration period so that all participants get all messages.  Sends announcements to mailing lists using Mail Chimp as directed by the Committee Leadership.',150,4,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (16,'Info - Syllabus Coordinator','There are two parts to this role. It is recommended that the same person does both as the two need to be kept exactly the same. Having a single person do this reduces communications requirements.',160,4,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (17,'Info - WebMaster','Ensures the website is operating correctly, reports issues to the website programmer, turns on and off different aspects of the website at the direction of the committee leadership.  Provides 2nd Level (i.e., sub-committee leads are first level) technical Support for Website.',170,4,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (18,'Info - Web Base Report Writer','Creates standard and ad-hoc reports using ODBC connection to the web base.',180,4,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (19,'Info - Website Programmer','Adds functionality to the web application, www.nefamilyhistory.com, makes improvements to existing functionality.',190,4,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (20,'Info - Photographer','Documents the conference, attendance, speakers etc.',200,4,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (21,'Publicity Committee Lead','Works with Information Committee and others to develop ensure that both church and community leaders have what they need to publicize the conference.',9,5,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (22,'PUB - Public Affairs','Ensures that local community is aware of the conference.',230,5,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (23,'Publicity Committee Member','Supports committee lead in assembling packages and distributing publicity materials.  Maybe a FH Consultant.',240,5,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (24,'FH Consultant Coordinator','Engages family history consultants stakewide to support the conference.',250,5,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (25,'Technical Committee Lead','Leads the Tech Sub-committee in - Setup of all technology needs for the day of the conference * Obtaining (borrowing/transporting) projectors * Running wiring * Audio where needed * Internet service (limited to speakers depending on bandwidth available) * Video recording - Assists Speakers on the day of the conference',10,6,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (26,'Tech Committee Member','Helps with setup of technology needs for the day of the conference including.',270,6,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (27,'Setup Committee Lead','Identifies volunteers to be Setup Helpers. Understands setup requirements. Assigns specific tasks to committee members. Directs setup committee during the 2-day setup period. Some cleaning maybe required of setup committee, bathrooms, vacuuming, etc.  Resources: Setup photographs and diagrams, General Signage Plan and laminated signs.',11,7,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (28,'Setup Committee Member','Follows direction of Setup Committee Lead during setup period from 2 days before the conference.',290,7,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (29,'Setup Decorations Coordinator','Decorates the dining tables and the speaker lounge.  ',300,7,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (30,'Parking Committee Lead','Arranges for parking on the day of the conference.  Ensures specific parking issues are resolved.',310,8,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (31,'Parking Committee Member','Guides vehicle drivers in where to park.',320,8,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (32,'Lunch Lead','Each year a specific ward is chosen to use the conference lunch preparation as a fundraiser for the youth of the ward.  The Lunch Lead works with specific ward youth to plan, purchase, assemble and distribute a packed lunch for all participants, who purchased a lunch during pre-registration.  The lead is given a budget as determined by Conference Committee leadership.  Lunch is also provided for the speakers (free), the missionaries (free), the committee members are expected to pay for a lunch(committee members should be signed up as participants so that their lunches can be counted).  See below, (under Design Lunch Menu task) very detailed write-up of how to put the lunch fundraiser together.',330,9,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (33,'Networking Refreshments','Plans, purchases and arranges refreshments for networking session at the end of the conference within budget as determined by Conference Committee leadership.',340,9,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (34,'Clean-up Committee Lead','Identifies volunteers to be Cleanup Helpers. Understands cleanup requirements. Assigns specific tasks to committee members. Directs setup committee during cleanup after the conference. All reusable signs to be returned to FHC Closet.',12,10,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (35,'Clean Up Committee Member','The cleanup helper follows the direction of the Clean Up Lead. Cleanup helpers may be needed before the conference to prepare the rooms as well as after the conference.',360,10,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (36,'Info - Conduct Conference Evaluations','Develop, distribute, analyse results and present feedback from conference participants and committee members.',210,4,0);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (37,'PARTICIPANT','',110,3,NULL);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (38,'Food Committee Lead','Ensures that the Lunch Lead and the Networking Refreshments coordinator understand their roles.  Cater the speaker lounge and ensure there is adequate water for breaks.  Interfaces with leadership if there are any issues.',6,9,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (42,'Program Committee Lead','Ensures the program is balanced between meeting the needs of the church members and community members.  Provides variety within a particular conference and over one conference to another.',4,11,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (40,'Program Committee Member','Assists in the development of the program.  Researches new speakers.  Engages the speaker and works with them to clarify their topic.  Captures information about the speakers and their presentations in the web application.  www.nefamilyhistory.com .  Hands off speaker to Speaker Host once the speaker and presentation information are complete in the web base.',40,11,1);
INSERT INTO `committee_roles` (`id`, `role_name`, `description`, `seq_no`, `committee_committee_id`, `name_tag_needed`) VALUES (43,'Speaker Lounge Caterer','Purchases and displays snacks for the speakers in the speaker lounge.  ',43,9,0);
...
INSERT INTO `committees` (`id`, `code`, `name`, `description`, `seq_no`, `oversight_role_assignment_id`) VALUES (2,'HOST','Host Committee','Where necessary, ensures that the speakers have transportation and/or lodging.  Hosts the speaker on the day of the conference.  Conveys speaker requirements to setup committee.',4,17);
INSERT INTO `committees` (`id`, `code`, `name`, `description`, `seq_no`, `oversight_role_assignment_id`) VALUES (3,'REG','Registration Committee','Ensures that the registration process is smooth both during the on-line pre-registration (participant information and payment) and day-of registration.  Ensures that the participant records are accurate and complete in preparation for assembling the participant packets.  Conveys registration specific setup requirements to setup committee.',3,19);
INSERT INTO `committees` (`id`, `code`, `name`, `description`, `seq_no`, `oversight_role_assignment_id`) VALUES (4,'INFO','Information Committee','Ensures that information flows smoothly and meets the needs of all committees, ensures that the web application and database are being used effectively.',8,19);
...
INSERT INTO `committees` (`id`, `code`, `name`, `description`, `seq_no`, `oversight_role_assignment_id`) VALUES (9,'FOOD','Food Committee','Purchase, preparation and display of food and drink for the day of the conference.  This includes the lunch, the networking refreshments, bottled water for breaks and catering of the speaker lounge.',5,17);
...
INSERT INTO `meetings` (`id`, `name`, `purpose`, `agenda`, `month_week`, `month_month_id`, `seq_no`, `facilitator_committee_role_id`, `notes`) VALUES (2,'Committee Orientation','To orient committee members to how the conference planning process works.','1. Introductions\r\n2. Review high level plan (key tasks and handoffs)\r\n3. Establish group norms regarding communication etc.\r\n4. Establish meeting schedule\r\n\r\n',1,4,4,3,'This meeting should be conducted face-to-face.');
...
INSERT INTO `meetings_invitees_committee_roles` (`committee_role_dest_id`, `meeting_src_id`) VALUES (5,20);
INSERT INTO `meetings_invitees_committee_roles` (`committee_role_dest_id`, `meeting_src_id`) VALUES (6,20);
INSERT INTO `meetings_invitees_committee_roles` (`committee_role_dest_id`, `meeting_src_id`) VALUES (8,20);
...
INSERT INTO `meetings_invitees_committee_roles` (`committee_role_dest_id`, `meeting_src_id`) VALUES (10,3);
INSERT INTO `meetings_invitees_committee_roles` (`committee_role_dest_id`, `meeting_src_id`) VALUES (10,16);
...
INSERT INTO `meetings_invitees_committee_roles` (`committee_role_dest_id`, `meeting_src_id`) VALUES (43,20);
...
INSERT INTO `role_assignments` (`id`, `name`, `event_event_id`, `volunteer_volunteer_id`, `committee_role_committee_role_id`) VALUES (7,'Payment Registrar - Priesthood Holder: Hielner (2013)',9,16,10);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (100,'REG - Identify Unpaid Participants','When all checks have been received, the Payment Registrar will provide the Registration Lead with a list of participants who have not paid.',1,70,10,NULL,102,10,0);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (101,'REG - Recieve checks and processes bank deposits','Receive check and record in system. Create periodic deposit (group of checks) and print deposit slip for bank. Recheck that each check is correctly recorded on the deposit slip. Make any adjustments in the system and recreate the deposit if necessary.',1,68,10,NULL,197,10,0);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (102,'REG - Record which participants each check covers','A critical element of this role is to indicate which participants are being paid for by a given check. Often a participant will pay for a friend or family member. This step is essential in ensuring a smooth registration process. If it is unclear whether someone has paid it causes a great deal of heartache for both the participant and the registration comittee.',1,69,10,NULL,NULL,10,1);
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (103,'REG - Send payment reminder to participant','Often a participant will sign up for the conference, but then will forget to pay.  We provide the ability for the Payment Registrar to create a list of emails to send a reminder email to.  The team member can either use their own email account or use the conference account nefamilyhistory@gmail.com',2,95,11,NULL,100,10,0);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (198,'HOST - Assign Lodging/Transportation Provider to Speaker','Introduce the Speaker, usually via email, to the person(s) who will be providing them with transportation or lodging.',2,94,11,NULL,207,40,0);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (143,'HOST - Manage Participant Classroom Entry','On the day of the conference, participants who pre-registered for a class get priority over those who walked in on the day of the conference. The host ensures that the pre-registered people (name tag color distinguishes pre-registered participants from walk-ins).',4,140,12,NULL,NULL,6,0);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (197,'REG - Setup Post Office Box','The payment reigstrar sets up a Post Office Box in a location that is convenient to him.  The PO Box will be used as the address where participants will send their checks for lunch and syllabus.',4,80,10,NULL,74,10,0);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (207,'HOST - Identify Lodging Providers/Transportation Providers','Create list of church members willing to host a speaker in their home for one or two nights.  Create list of church members willing to drive a speaker from or to the airport.',1,40,7,NULL,137,5,0);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (241,'HOST - Arrange Speaker Packets','',4,241,12,14,2,5,0);
...
INSERT INTO `task_objs` (`id`, `name`, `description`, `month_week`, `seq_no`, `month_month_id`, `meeting_meeting_id`, `predecessor_task_obj_id`, `committee_role_committee_role_id`, `key_task`) VALUES (247,'FOOD - Cater Speaker Lounge','Provide light breakfast snacks for the speakers for example, fruit and banana bread. ',4,247,12,NULL,NULL,43,0);
...
INSERT INTO `task_objs_resources_resources` (`task_obj_src_id`, `resource_dest_id`) VALUES (94,7);
...
-- Dump completed on 2013-06-03 20:39:25
